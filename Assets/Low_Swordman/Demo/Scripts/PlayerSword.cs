...
public class PlayerSword : PlayerController
{
    ...
    private void Start()
    {
        ...
        m_Anim = this.transform.Find("m_model").GetComponent<Animator>();
    ...
    public void checkInput()
    {
        ...
        if (m_Anim.GetCurrentAnimatorStateInfo(0).IsName("p_Sit") || m_Anim.GetCurrentAnimatorStateInfo(0).IsName("p_Die"))
        {
        ...
        if (!m_Anim.GetCurrentAnimatorStateInfo(0).IsName("p_Attack"))
        {
            if (Input.GetKey(KeyCode.Mouse0))
            {


                m_Anim.Play("p_Attack");
            }
            else
            {
    ...
    protected override void LandingEvent()
    {
        ...
        if (!m_Anim.GetCurrentAnimatorStateInfo(0).IsName("p_Run") && !m_Anim.GetCurrentAnimatorStateInfo(0).IsName("p_Attack"))
            m_Anim.Play("p_Idle");
